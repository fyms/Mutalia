...
export default async function SimulateurPage({
  ...
  const activeTab = tab === "conventions" ? "conventions" : tab === "plafond" ? "plafond" : "remboursement";
  ...
  return (
    <div>
      ...
      {activeTab === "conventions" ? <ConventionSimulator /> : activeTab === "remboursement" ? <ReimbursementSimulator /> : <AnnualCapSimulator />}
    </div>
  );
}

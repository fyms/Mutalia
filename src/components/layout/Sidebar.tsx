...
import { CalendarDays, LayoutDashboard, Search, UserRoundPlus, Users, ShieldCheck, Wallet, MessagesSquare, Inbox, Receipt, ClipboardCheck, TriangleAlert, FolderOpen, Calculator, GraduationCap, BookOpen, CircleHelp, Settings, FileSignature, ListChecks, ChartNoAxesCombined } from 'lucide-react';
import { Logo } from './Logo';
const groups = [
  { title: 'Pilotage', items: [['Cockpit','/cockpit',LayoutDashboard],['Agenda','/agenda',CalendarDays],['Recherche','#recherche',Search]] },
  { title: 'Commercial', items: [['Prospects','/prospects',UserRoundPlus],['Simulateur','/simulateur',Calculator]] },
  ...
  { title: 'Documents & outils', items: [['GED','/documents',FolderOpen]] },

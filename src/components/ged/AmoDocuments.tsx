...
export function AmoDocuments({owner,caseId}:{owner:string;caseId?:string}) {
 ...
 <h2>Décomptes AMO générés — Démo</h2><p className="m-help">Copies pédagogiques personnelles, distinctes des documents sources et des pièces à corriger.</p>

...
export function AppointmentForm({initial,householdId,households,onDone,onCancel,lockHousehold=false,prospects=[],prospectId}:{prospects?:Prospect[];lockHousehold?:boolean;onCancel?:()=>void;prospectId?:string;initial?:Appointment;householdId?:string;households:{id:string;name:string}[];onDone:()=>void}){

import type { ProspectSales } from "./prospectSales";
import { z } from "zod";
...
export interface Prospect extends z.infer<typeof ProspectInputSchema> {id:string;createdAt:string;updatedAt:string;status:"actif"|"converti"|"abandonné";revision:number;householdId?:string;sales?:ProspectSales;}

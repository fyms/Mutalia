...
export interface RuntimeDocument {
 id:string;ownerId:string;householdId:string;prospectId?:string;beneficiaryId:string;documentType:string;originalFileName:string;storedFileName:string;mimeType:string;size:number;documentDate:string;note:string;source:"generated"|"uploaded";status:DocumentStatus;createdAt:string;createdBy:string;caseId?:string;
}
export type RuntimeDocumentView=Omit<RuntimeDocument,"ownerId"|"storedFileName"|"createdBy">;
export const documentView=(d:RuntimeDocument):RuntimeDocumentView=>({id:d.id,householdId:d.householdId,prospectId:d.prospectId,beneficiaryId:d.beneficiaryId,documentType:d.documentType,originalFileName:d.originalFileName,mimeType:d.mimeType,size:d.size,documentDate:d.documentDate,note:d.note,source:d.source,status:d.status,createdAt:d.createdAt,caseId:d.caseId});
